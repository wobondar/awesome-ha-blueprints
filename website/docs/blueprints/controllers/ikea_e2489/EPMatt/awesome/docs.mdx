...
This blueprint provides universal support for running any custom action when a button is pressed on the provided IKEA E2489 BILRESA remote control with buttons. Supports controllers integrated with Zigbee2MQTT. The blueprint will automagically detect the integration type and take care of all the rest.
